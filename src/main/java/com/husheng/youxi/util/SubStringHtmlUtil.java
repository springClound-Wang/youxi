    ...
    public static void main(String[] args) {
        System.out
                .println(subStringHTML(
                        "<a>要配置几个项目就写几个Host标签。</a><p class='test'>其中，defaultHost是输入服务器ip地址默认访问的网站，如果为空则访问tomcat控制台；</p><p>name就是网站的域名；</p><p>appBase是项目放置的根目录，这里我全部放置在tomcat默认的目录下，当然你也可以新建其他目录；</p><p>docBase是项目的根目录；</p>",
                        30, ""));
    }
    /**
     * 
